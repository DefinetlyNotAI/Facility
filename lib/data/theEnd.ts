...
export const messages = {
    memoryFragments: [
        {text: "remember when you were human?", style: {top: '5%', left: '10%'}},
        {text: "the first time you smiled...", style: {top: '15%', right: '15%'}},
        {text: "before the roots took hold", style: {bottom: '35%', left: '5%'}},
        {text: "you chose this", style: {bottom: '5%', right: '10%'}},
    ] as MemoryFragment[],
    nostalgicLines: [
    ...
    invalidKeywordErr: "Do not lie, for you spoke what was not taught to you." as string,
    console: [
    ...
    questionInput: {
        ...
        subtitle: [
            ...
            "So speak the word that you earned,",
            "The one you got from the countless battles."
        ],
        placeholder: "The word taught to you by me - But when you answer you won't go back...",
        buttonLabel: "Speak"
    },
    htmlComment: {
        question: [
