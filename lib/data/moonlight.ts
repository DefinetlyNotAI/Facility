...
export const MESSAGES = {
    start: "Click to see the moon with me",
    continue: "Click to continue...",
};
export const HOVER = {
    blood: 'The crimson moon holds secrets... click to unveil them.',
    normal: 'The peaceful moon watches over the night.',
}

// Moonlight riddle location - Blood moon
export const RIDDLE_LOCATION = {
    href: '/static/moonlight/riddle.hex',
    name: 'riddle.hex',
}
...
// Special Easter eggs lines
export const SOOTHING_EGG = [
