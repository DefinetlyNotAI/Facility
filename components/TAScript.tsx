export const PAGE_HINTS: Record<string, string[]> = {
    ...
    '/wifi-login': [
        "Username and password time! The credentials might be hiding in plain sight around the facility.",
        "Maybe the characters limit for the password is a clue... think about it.",
        "The username and password are not just random - they relate to my creator.",
    ],
    '/media': [
    ...
    '/file-console': [
        ...
        "Some files can be downloaded with 'wget' - you might need them!",
        "That robots.txt file is particularly interesting. Web crawlers aren't the only ones reading it.",
        "The riddle PDF and hint file might be special. Download them both!",
        "Invoke the shell, find two truths, one of identity and one of power."
    ],
    '/buttons': [
        "Five browsers, but you can only press the one matching yours. It's a global system!",
        "Once all browsers are pressed by different people, something special unlocks and it becomes a easy trail.",
        "This is a collaborative puzzle. A one of a kind, The hub that connects all... wait, I shouldn't say that yet.",
    ],
    '/black-and-white': [
        "Two QR codes... one's telling the truth, one's lying. A classic puzzle!",
        "Want to find the moon? Type the hidden number and be lucky.",
        "Listen well, use your ears.",
        "The screen size matters for the final unlock.",],
    '/h0m3': [
        "...",
    ],
    '/scroll': [
