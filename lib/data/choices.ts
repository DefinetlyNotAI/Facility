...
export const REPEAT_VIEW_MSG: string[] = [
...
export function getBeginningMonologue(os: string, browser: string): string[] {
    return [
...
export const SPECIAL_EASTER_EGG = {
    MESSAGE: "who are you",
    EGG_ID: 4,
}
export const EASTER_EGG_DATA = [
    ...
    {
        regex: new RegExp(SPECIAL_EASTER_EGG.MESSAGE, "i"),
        egg: SPECIAL_EASTER_EGG.EGG_ID,
...
export const EASTER_EGG_COUNTER_MSG: string = "Eggs in trees"

// Punishment Messages
export const PUNISHMENT_MSG = {
...
// Cutscene Messages
export const CUTSCENE_LINES: string[] = [
    "...",
...
export const FINALE_MSG = "REMEMBER ME IN THE STATIC.";
